...
{
    public interface IEthereumApi : IBlockchainApi
    {
        /// <summary>
        ...
        Task<(IEnumerable<EthereumTransaction> txs, Error error)> GetTransactionsAsync(
            string address,
        ...
        Task<(decimal? gasPrice, Error error)> GetFastGasPriceAsync(
            CancellationToken cancellationToken = default);
        ...
        Task<(int? estimatedGas, Error error)> EstimateGasAsync(
            string to,
            string from = null,
