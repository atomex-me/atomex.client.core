...
{
    public class HdWallet_OLD : IHdWallet_OLD
    {
        public HdKeyStorage_OLD KeyStorage { get; }

        public string PathToWallet { get; set; }
        public Network Network => KeyStorage.Network;
        public bool IsLocked => KeyStorage.IsLocked;

        private HdWallet_OLD(string pathToWallet, SecureString password)
        {
            ...
            Network network = Network.MainNet)
        {
            ...
            KeyStorage = new HdKeyStorage_OLD(
                mnemonic: mnemonic,
                wordList: wordList,
        ...
        public WalletAddress_OLD GetAddress(
        ...
        public static HdWallet_OLD LoadFromFile(string pathToWallet, SecureString password) =>
