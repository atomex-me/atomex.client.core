...
{
    public class HdKeyStorage_OLD : IKeyStorage_OLD
    {
        ...
        public HdKeyStorage_OLD Unlock(SecureString password)
        {
            try
            {
                var seed = new AesCbc(
        ...
        public static HdKeyStorage_OLD LoadFromFile(string pathToFile, SecureString password)
        {
            ...
            try
            {
                ...
                result = JsonConvert.DeserializeObject<HdKeyStorage_OLD>(json);
