...
{
    public class TezosTransaction_OLD : IAddressBasedTransaction_OLD
    {
        ...
        public List<TezosTransaction_OLD> InternalTxs { get; set; }

        public TezosTransaction_OLD Clone()
        {
            var resTx = new TezosTransaction_OLD()
            {
                Id           = Id,
                Currency     = Currency,
                State        = State,
                ...
                InternalTxs   = new List<TezosTransaction_OLD>(),
