...
namespace Atomex.Blockchain.Tezos.Tzkt
{
    public class TzktApi_OLD : BlockchainApi_OLD, ITezosBlockchainApi_OLD, ITokenBlockchainApi
    {
        ...
        {
            var tx = (TezosTransaction_OLD)transaction;
        ...
        public async Task<Result<IEnumerable<IBlockchainTransaction_OLD>>> GetTransactionsAsync(
            string address,
            CancellationToken cancellationToken = default)
        {
            ...
            return new Result<IEnumerable<IBlockchainTransaction_OLD>>(txsResult.Value);
        }

        public async Task<Result<IEnumerable<IBlockchainTransaction_OLD>>> TryGetTransactionsAsync(
            string address,
            int attempts = 3,
        ...
        public async Task<Result<IEnumerable<TezosTransaction_OLD>>> GetTransactionsAsync(
            string from,
            string to,
            string parameters,
            CancellationToken cancellationToken = default)
        ...
        public async Task<Result<IEnumerable<TezosTransaction_OLD>>> TryGetTransactionsAsync(
            string from,
            string to,
            string parameters,
            int attempts = 10,
        ...
        private Result<IEnumerable<TezosTransaction_OLD>> ParseTxs(
            JArray data)
        {
            var result = new List<TezosTransaction_OLD>();
