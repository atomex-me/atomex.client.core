...
{
    public class EthereumTransaction_OLD : IAddressBasedTransaction_OLD
    {
        ...
        public List<EthereumTransaction_OLD> InternalTxs { get; set; }

        public EthereumTransaction_OLD()
        {
        }
        ...
        public EthereumTransaction_OLD(string currency, TransactionInput txInput)
        {
            Currency     = currency;
            Type         = BlockchainTransactionType.Unknown;
        ...
        public EthereumTransaction_OLD Clone()
        {
            var resTx = new EthereumTransaction_OLD()
            {
                Currency      = Currency,
                Id            = Id,
                Type          = Type,
                ...
                InternalTxs   = new List<EthereumTransaction_OLD>(),
